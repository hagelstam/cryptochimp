...
When working with Next.js, search for the latest documentation and best practices using the next-devtools-mcp tool to ensure accuracy and current implementation patterns.
